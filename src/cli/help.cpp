...
void help() {
    std::cout
        << "Welcome in " ITALIC GREEN "ims-t6" RESET " help by " XSLEZA26 RESET
           ...
           "    is once every 60 seconds)\n"
           "\n"
           "  " YELLOW "--min-duty " WHITE "<uniform-min>" RESET "\n"
           "    Set the minimum time a single operator will work until\n"
           "    switching with another operator. Default value is 2700.\n"
           "\n"
           "  " YELLOW "--max-duty" WHITE " <uniform-max>" RESET "\n"
           "    Set the maximum time a single operator will work until\n"
           "    switching with another operator. Default value is 4500.\n"
           "\n"
           "  " YELLOW "--switch-time" WHITE " <exp>" RESET "\n"
           "    Set the time it takes two operators to switch. Default value\n"
           "    is 30.\n"
           "\n" GREEN "Notes:" RESET "\n"
